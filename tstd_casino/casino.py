...
try:
    l_path = "data/mod-cogs/tstd_casino/data/languages.json"
    lang_data = dataIO.load_json(l_path)
    lang_default = lang_data["Language"]
    language_set = gettext.translation('tstd_casino', localedir='data/mod-cogs/tstd_casino/data',
